...
const (
	...
	// raft message
	// raft message is a special message, it will be sent by raft node
	// and will not be broadcast to other nodes which not in cluster
	XuperMessage_RAFT_MESSAGE XuperMessage_MessageType = 30
)
...
var fileDescriptor_9898f5d59e04eeea = []byte{
	...
	,
}
